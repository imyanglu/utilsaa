...
extension PlanQueryFilter on QueryBuilder<Plan, Plan, QFilterCondition> {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> timeInMinutesEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> timeInMinutesGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> timeInMinutesLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> timeInMinutesBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlanQuerySortBy on QueryBuilder<Plan, Plan, QSortBy> {
  ...
  QueryBuilder<Plan, Plan, QAfterSortBy> sortByTimeInMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeInMinutes', Sort.asc);
    });
  }

  QueryBuilder<Plan, Plan, QAfterSortBy> sortByTimeInMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlanQuerySortThenBy on QueryBuilder<Plan, Plan, QSortThenBy> {
  ...
  QueryBuilder<Plan, Plan, QAfterSortBy> thenByTimeInMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeInMinutes', Sort.asc);
    });
  }

  QueryBuilder<Plan, Plan, QAfterSortBy> thenByTimeInMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeInMinutes', Sort.desc);
    });
  }
...
extension PlanQueryWhereDistinct on QueryBuilder<Plan, Plan, QDistinct> {
  ...
  QueryBuilder<Plan, Plan, QDistinct> distinctByTimeInMinutes() {
    return QueryBuilder.apply(this, (query) {
...
extension PlanQueryProperty on QueryBuilder<Plan, Plan, QQueryProperty> {
  ...
  QueryBuilder<Plan, int, QQueryOperations> timeInMinutesProperty() {
    return QueryBuilder.apply(this, (query) {
